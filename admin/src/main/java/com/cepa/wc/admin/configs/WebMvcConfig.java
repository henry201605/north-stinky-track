package com.cepa.wc.admin.configs;

import com.cepa.wc.beans.User;
import com.cepa.wc.commons.pojos.Response;
import com.cepa.wc.commons.utils.CookieUtil;
import com.cepa.wc.commons.utils.GsonUtils;
import com.cepa.wc.springboot.support.Cookies;
import com.cepa.wc.springboot.support.ResponseCode;
import com.cepa.wc.springboot.support.annotations.LoginRequired;
import com.cepa.wc.springboot.support.controller.BaseController;
...
//        if (user == null && CepaValidates.containsAny(env.getActiveProfiles(), Profiles.MABB, Profiles.ZHANGW)) {
