...
public final class NepaArrays {
    ...
    public static <T> Integer[] ints(T[] array){
        return transfer(array,
                v -> {
                    ...
                    else return NumberUtils.toInt(NepaStrings.str(v),0);
                }, Integer[]::new);
    }
    ...
    public static <T> Long[] longs(T[] array){
        return transfer(array,
                v -> {
                    ...
                    else return NumberUtils.toLong(NepaStrings.str(v),0l);
                }, Long[]::new);
    }
    ...
    public static Long getLong(Object[] result, int i, Long l) {
        return NumberUtils.toLong(NepaStrings.str(get(result,i)),l);
    }
    ...
    public static String getString(Object[] result, int i) {
        return NepaStrings.str(get(result,i));
    }
