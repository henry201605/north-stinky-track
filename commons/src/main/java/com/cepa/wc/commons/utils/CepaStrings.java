...
public final class CepaStrings {
    private static final Logger LOG = LoggerFactory.getLogger(CepaStrings.class);
    ...
    public static String str(Object obj,String defaultVal){
        ...
        else if(obj instanceof Date) result = CepaDates.format((Date) obj);
    ...
    public static String join(Set<?> list, String separator) {
        ...
        if (list != null && list.size() > 0) {
            ...
            for (Object item : list) {
                output = output + CepaStrings.str(item);
                output = output + separator;
                joined = true;
            }
    ...
    public static byte[] bytes(Object key,String charset) {
        ...
        try {
            String str = CepaStrings.str(key);
