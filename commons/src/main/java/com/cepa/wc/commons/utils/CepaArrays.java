...
public final class CepaArrays {
    ...
    public static <T> Integer[] ints(T[] array){
        return transfer(array,
                v -> {
                    ...
                    else return NumberUtils.toInt(CepaStrings.str(v),0);
                }, Integer[]::new);
    }
    ...
    public static <T> Long[] longs(T[] array){
        return transfer(array,
                v -> {
                    ...
                    else return NumberUtils.toLong(CepaStrings.str(v),0l);
                }, Long[]::new);
    }
    ...
    public static Long getLong(Object[] result, int i, Long l) {
        return NumberUtils.toLong(CepaStrings.str(get(result,i)),l);
    }
    ...
    public static String getString(Object[] result, int i) {
        return CepaStrings.str(get(result,i));
    }
